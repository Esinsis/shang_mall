    ...
    <div class="order-right">
        <div class="order-content">
                        ...
                        <tr v-for="(detail, index) in order.orderDetailList" :key="detail.id">
                            <td width="60%">
                                <div class="typographic">
                                    <img :src="detail.imgUrl" style="height: 100px; width:100;">
            ...
            <div class="choose-order">
                <Pagination :pageNo="page" :pageSize="limit" :total="total" :pageCount="5" @currentPage="currentPage" />
            </div>
        </div>
        <!--猜你喜欢-->
        <div class="like">
...
export default {
    ...
    methods: {
        async getData() {
            ...
            let result = await this.$API.getMyOrders(page, limit);
            if (result.code == 200) {
