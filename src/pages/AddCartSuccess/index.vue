  ...
  <div class="cart-complete-wrap">
    <div class="cart-complete">
      ...
      <div class="goods">
        <div class="left-good">
          <div class="left-pic">
            <img :src="goodInfo.skuInfo.skuDefaultImg">
          </div>
          <div class="right-info">
            <p class="title">{{ goodInfo.skuInfo.skuName }}</p>
            <p class="attr">{{ spuSaleAttr }} 数量：{{ $route.query.skuNum }}</p>
          </div>
        </div>
        <div class="right-gocart">
          <router-link class="sui-btn btn-xlarge" :to="`/detail/${goodInfo.skuInfo.id}`">查看商品详情</router-link> 
...
<script>
  export default {
    ...
    computed: {
      ...
      spuSaleAttr(){
        let goodInfo = JSON.parse(sessionStorage.getItem('SKUINFO'));
        let saleAttrs = goodInfo.spuSaleAttrList;
        let result = "";
